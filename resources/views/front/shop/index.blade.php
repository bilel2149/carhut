                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="shop-item col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                        <div class="inner-box">
                                            ...
                                            <div class="image-box">
                                                <figure class="image">
                                                    <a href="shop-single.html"><img src="{{asset('/uploads/products/')}}/{{ $product->product_thumbnail }}" alt="{{ $product->name }}">
                                                    </a>
                                                </figure>
                                                <div class="item-options clearfix">
                                                    ...
                                                    <a href="#" class="option-btn"><span class="fa fa-eye"></span><div class="tool-tip">Quick View</div></a>
                                                </div>
                                            </div>
