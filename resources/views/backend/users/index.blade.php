					...
					<div id="content">
						<div id="sortable-panel" class="">
							...
							<div id="titr-content" class="col-md-12">
								...
								<div class="actions">
									<a href="{{ route('users.create') }}" class="btn btn-success ">Ajouter un nouveau</a>
								</div>
							</div>
							<div class="col-md-12">
										    ...
										    <tbody>
											            ...
											            <td>
																		@if ($user->avatar && File::exists(public_path("uploads/users/".$user->avatar)))
																			<img src="{{asset('/uploads/users')}}/{{ $user->avatar }}" alt="{{ $user->avatar }}" style="max-width: 70px;"/>
																		@endif
																	</td>
                                  ...
                                  <td>{{ $user->email }}</td>
                                      ...
                                      <div class="">
                                        <ul class="list-inline">
                                          <li>
                                            <a href="{{ route('users.edit', $user->id) }}" class="btn btn-xs btn-teal tooltips" data-placement="top" data-original-title="Edit"><i class="fa fa-edit"></i></a>
                                          </li>
                                          <li>
                                            {!! Form::open([
      															            'method' => 'DELETE',
