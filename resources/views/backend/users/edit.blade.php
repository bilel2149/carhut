                  ...
                  @endif
                      ...
                      {{ method_field('PUT') }}
											<div class="row">
												<div class="col-md-6">
													<div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
														...
														<input type="text" placeholder="Nom" class="form-control" id="name" name="name" value="{{ $user->name }}">
														@if ($errors->has('name'))
                          ...
                          <div class="form-group{{ $errors->has('surname') ? ' has-error' : '' }}">
														...
														<input type="text" placeholder="Prénom" class="form-control" id="surname" name="surname" value="{{ $user->surname }}">
                          ...
                          <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
														...
														<input type="email" placeholder="Email" class="form-control" id="email" name="email" value="{{ $user->email }}">
														@if ($errors->has('email'))
		                            <span class="help-block">
                          ...
                          <div class="form-group">
                            ...
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                  ...
                                  @if ($user->avatar && File::exists(public_path("uploads/users/".$user->avatar)))
                                    <img data-src="" src="{{asset('/uploads/users')}}/{{ $user->avatar }}" alt="{{ $user->avatar }}"/>
                                  @else
                          ...
                          <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
														...
														<input type="text" placeholder="Téléphone" class="form-control" id="phone" name="phone" value="{{ $user->phone }}">
														@if ($errors->has('phone'))
		                            <span class="help-block">
                          ...
                          <div class="form-group">
                              ...
                              Nom de l'entreprise <span class="symbol required"></span>
														...
														<input type="text" placeholder="Nom de l'entrepris" class="form-control" id="company" name="company" value="{{ $user->company }}">
													</div>
                          <div class="form-group">
														<label for="adresse" class="control-label">
                              Adresse <span class="symbol required"></span>
														</label>
														<input type="text" placeholder="Adresse" class="form-control" id="adresse" name="adresse" value="{{ $user->adresse }}">
													</div>
                          <div class="form-group">
														<label for="cp" class="control-label">
                              Code postale <span class="symbol required"></span>
														</label>
														<input type="text" placeholder="Code postal" class="form-control" id="cp" name="cp" value="{{ $user->cp }}">
													</div>
                          <div class="form-group">
														<label for="city" class="control-label">
                              Ville <span class="symbol required"></span>
														</label>
														<input type="text" placeholder="Ville" class="form-control" id="city" name="city" value="{{ $user->city }}">
													</div>
                          <div class="form-group">
														<label for="country" class="control-label">
                              Pays <span class="symbol required"></span>
														</label>
														<input type="text" placeholder="Pays" class="form-control" id="country" name="country" value="{{ $user->country }}">
													</div>
												</div>
											</div>
											<div class="row">
