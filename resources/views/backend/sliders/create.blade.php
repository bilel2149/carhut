											...
											<div class="row">
												<div class="col-md-6">
													<div class="form-group{{ $errors->has('slider_title') ? ' has-error' : '' }}">
														...
														<input type="text" placeholder="Titre" class="form-control" id="slider_title" name="slider_title" value="{{ old('slider_title') }}">
													...
													<div class="form-group{{ $errors->has('slider_content') ? ' has-error' : '' }}">
														<div  class="panel panel-default">
															...
															<div class="panel-body no-padding">
																<textarea cols="80" id="slider_content" name="slider_content" rows="10"></textarea>
