				...
				<div class="row">
                  ...
                  @endif
											...
											<div class="row">
												<div class="col-md-6">
													<div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
														...
														<input type="text" placeholder="Nom" class="form-control" id="name" name="name" value="{{ old('name') }}">
														@if ($errors->has('name'))
                          ...
                          <div class="form-group{{ $errors->has('surname') ? ' has-error' : '' }}">
														...
														<input type="text" placeholder="Prénom" class="form-control" id="surname" name="surname" value="{{ old('surname') }}">
                          ...
                          <div class="form-group">
                            <label for="confirm" class="control-label">
                              Confirm. mot de passe <span class="symbol required"></span>
                            </label>
                            <input type="password" class="form-control" name="password_confirmation" id="confirm" placeholder="Confirmer votre mot de passe">
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
														...
														<input type="text" placeholder="Téléphone" class="form-control" id="phone" name="phone" value="{{ old('phone') }}">
														@if ($errors->has('phone'))
		                            <span class="help-block">
                          ...
                          <div class="form-group">
                              ...
                              Nom de l'entreprise <span class="symbol required"></span>
														...
														<input type="text" placeholder="Nom de l'entrepris" class="form-control" id="company" name="company" value="{{ old('company') }}">
													</div>
                          <div class="form-group">
														<label for="adresse" class="control-label">
                              Adresse <span class="symbol required"></span>
														</label>
														<input type="text" placeholder="Adresse" class="form-control" id="adresse" name="adresse" value="{{ old('adresse') }}">
													</div>
                          <div class="form-group">
														<label for="cp" class="control-label">
                              Code postale <span class="symbol required"></span>
														</label>
														<input type="text" placeholder="Code postal" class="form-control" id="cp" name="cp" value="{{ old('cp') }}">
													</div>
                          <div class="form-group">
														<label for="city" class="control-label">
                              Ville <span class="symbol required"></span>
														</label>
														<input type="text" placeholder="Ville" class="form-control" id="city" name="city" value="{{ old('city') }}">
													</div>
                          <div class="form-group">
														<label for="country" class="control-label">
                              Pays <span class="symbol required"></span>
														</label>
														<input type="text" placeholder="Pays" class="form-control" id="country" name="country" value="{{ old('country') }}">
													</div>
												</div>
											</div>
											<div class="row">
