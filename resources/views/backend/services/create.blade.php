				...
				<div class="row">
                  ...
                  @endif
											...
											<div class="row">
												<div class="col-md-6">
													<div class="form-group{{ $errors->has('service_title') ? ' has-error' : '' }}">
														...
														<input type="text" placeholder="Titre" class="form-control" id="service_title" name="service_title" value="{{ old('service_title') }}">
                          ...
                          <div class="form-group{{ $errors->has('service_slug') ? ' has-error' : '' }}">
														...
														<input type="text" placeholder="Slug" class="form-control" id="service_slug" name="service_slug" value="{{ old('service_slug') }}">
                          ...
                          <div class="form-group{{ $errors->has('service_content') ? ' has-error' : '' }}">
														...
														<textarea name="service_content" placeholder="Contenu" class="form-control" id="service_content" cols="80" rows="10">{{ old('service_content') }}</textarea>
