				...
				<div class="row">
                  ...
                  @endif
							...
							<div class="col-md-12 ">
		                        ...
		                        @endif
													...
													<div class="form-group{{ $errors->has('slug') ? ' has-error' : '' }}">
														...
														<input type="text" placeholder="Slug" class="form-control" id="slug" name="slug" value="{{ old('slug') }}">
														@if ($errors->has('slug'))
		                            <span class="help-block">
                          ...
                          <div class="form-group{{ $errors->has('promo') ? ' has-error' : '' }}">
														...
														<input type="number" class="form-control" id="promo" name="promo" value="{{ old('promo') }}">
														@if ($errors->has('promo'))
		                            <span class="help-block">
		                        ...
		                        @endif
												...
												<div class="col-md-6">
													<div class="form-group{{ $errors->has('details') ? ' has-error' : '' }}">
														...
														<textarea name="details" placeholder="Détail" class="form-control" id="details" cols="80" rows="10">{{ old('details') }}</textarea>
                          ...
                          <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
														...
														<textarea name="description" placeholder="Description" class="form-control" id="description" cols="80" rows="10">{{ old('description') }}</textarea>
