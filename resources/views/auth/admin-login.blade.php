...
<html>
	<head>
		<title>Carhut Admin - Login</title>
		<meta charset="utf-8">
                  ...
                  {{ csrf_field() }}
                    ...
                    <div  class="input-group{{ $errors->has('email') ? ' has-error' : '' }}">
                        ...
                        @endif
										...
										<div class="spacing"></div>
										<div class="checkbox checkbox-primary"> <input id="remember" type="checkbox" name="remember" {{ old('remember') ? 'checked' : '' }} > <label for="remember"> Remember me </label> </div>
                    <button type="submit" id="singlebutton" name="singlebutton" class="btn btn-success btn-sm  pull-right">Login</button>
									</fieldset>
								</form>
								<a id="forget" href="{{ route('admin.password.request') }}" class="grey">Forget Password?</a>
							</div>
